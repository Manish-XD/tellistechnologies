...
const styles = {
  ...
  container: "max-w-[1200px] w-full flex flex-col-reverse md:flex-row px-[20px] md:px-[0px]",
  ...
  darkContainer: "mt-[100px] mb-[90px] bg-[#023A15] p-[30px] md:p-[80px] relative md:translate-x-[-150px] md:block flex flex-col items-center",
  ...
  counterContainer: "flex flex-col items-center md:flex-row justify-between mt-[50px] w-full md:w-[60%] text-black",
