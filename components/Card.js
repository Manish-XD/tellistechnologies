...
const Card = ({ src, alt, title, description, about }) => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-white p-[20px] shadow-lg rounded-[10px] w-[90%] md:w-[80%] translate-y-[-2.5rem] flex flex-col items-center">
        ...
        {!about && <Link href={`/servicedetails/${stringTrim(title)}`} className='text-[#319E48] underline flex items-center'>
            LEARN MORE
        ...
        {about && <div>
            <div className="">
                        ...
                        <div className=''>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" className=''>
